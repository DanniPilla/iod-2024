...
router.put("/:id", (req, res) => {
  ...
  let updatedFriend = req.body; // Get the new friend data from the request body
  let friend = friends.find((friend) => friend.id === friendId);

  if (friend) {
    // If the friend is found, update their data with the new info
    friend.name = updatedFriend.name || friend.name;
    friend.gender = updatedFriend.gender || friend.gender;
